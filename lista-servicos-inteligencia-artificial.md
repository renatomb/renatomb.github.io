---
layout: post
title:  "Lista de serviços de inteligência artificial"
date:   2023-01-30 20:19:00 -0300
permalink: /inteligencia-artificial/
tags: [inteligência artificial, listas]
...
- [Jasper](https://jasper.ai?source=partner&fpr=renatomb)
- [Midjourney](https://midjourney.com/)
- [neural.love](https://neural.love/)
- [Nightcafe](https://nightcafe.studio/)
- [pixray-text2image](https://pixray.gob.io/)
- [Stable Diffusion Models for Image Generation](https://stablediffusionweb.com/)
- [Wombo](https://www.wombo.ai/)
- Wonder AI [iPhone](https://apps.apple.com/us/app/wonder-ai-art-generator/id1621278575) [Android](https://play.google.com/store/apps/details?id=com.codeway.wonder&hl=pt_BR&gl=US&pli=1)

## Inteligência Artificial para criar vídeos a partir de texto
...
## Inteligência Artificial para criar audio a partir de texto
...
- [Wellsaid](https://wellsaid.co/)

## Inteligência Artificial para criar textos a partir de texto
...
- [GooseAI](https://goose.ai/playground)
- [ResearcheAI](https://research-ai.io/)
- [Writesonic](https://writesonic.com?via=renatomb)
- [copymatic](https://copymatic.ai/)
- [co:here](https://cohere.ai/)
- [Chibi](https://chibi.ai/)
- [ideanote](https://ideanote.io/idea-generator)
- [CopySmith](https://copysmith.ai/)
- [flowrite](https://www.flowrite.com/)
- [Niches$$](https://nichesss.com/)
